...
public class AlquilerServiceImplementacion implements AlquilerService {
    ...
    public AlquilerServiceImplementacion(JsonPeliculaDao peliculaDao, JsonSocioDao socioDao, JsonAlquilerDao alquilerDao) {
    ...
    public AlquilerServiceImplementacion(String basePath) {
        this.peliculaDao = new JsonPeliculaDaoImplementacion(basePath + "/peliculas.json");
        this.socioDao = new JsonSocioDaoImplementacion(basePath + "/socios.json");
        this.alquilerDao = new JsonAlquilerDaoImplementacion(basePath + "/alquileres.json");
        this.limitePorSocio = 3;
    }
